            ...
            <div class="col-md-12">
                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4 class="d-flex">Flight Booking Request
                             @can('flight booking list csv export')
                            <a href="{{ route('flight-booking.export.csv',['date_from'=>$request->date_from,'date_to'=>$request->date_to,'bill_to'=>$request->bill_to,'keyword'=>$request->keyword]) }}" class="btn btn-sm btn-cta ms-auto" data-bs-toggle="tooltip" title="Export data in CSV">
                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="white-space:nowrap;">Departure Date</th>
                                    <th style="white-space:nowrap;">Preferred Departure Time</th>
                                    <th>Return Date</th>
                                    <th>Return Time</th>
                                    <th>Traveller</th>
                                ...
                                @forelse ($data as $index => $item)
                                        ...
                                        @foreach ($formattedTravellers as $key => $traveller)
                                            ...
                                            <tr>
                                                @if ($key == 0)
                                                    ...
                                                    <td rowspan="{{ count($formattedTravellers) }}">{{ $item->departure_date }}</td>
                                                    <td rowspan="{{ count($formattedTravellers) }}">{{ $item->arrival_time }}</td>
                                                    <td rowspan="{{ count($formattedTravellers) }}">
                                                ...
                                                <td style="white-space: nowrap;">
                                                    @can('flight booking details')
                                                        <a href="{{ url('flight-booking/details/'.$item->id) }}" class="btn btn-cta">
                                                    ...
                                                    @can('update flight booking')
                                                        <a href="{{ url('flight-booking/'.$item->id.'/edit') }}" class="btn btn-cta">
                                    ...
                                    @else
                                        <tr>
                                            ...
                                            <td>{{ $item->trip_type == 2 ? ($item->return_date ?? '') : '' }}</td>
                                            <td>{{ $item->trip_type == 2 ? ($item->return_time ?? '') : '' }}</td>
                                            <td>N/A</td> <!-- No traveler -->
                                            <td>N/A</td> <!-- No seat preference -->
                                            <td>N/A</td> <!-- No food preference -->
