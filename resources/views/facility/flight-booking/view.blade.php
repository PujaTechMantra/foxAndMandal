                   ...
                   <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="mt-3" id="remarksBox" style="display: none;">
                                <form method="POST" action="{{ url('flight-booking/status/change/'.$data->id.'/4') }}" enctype="multipart/form-data">
                                    @csrf
                            ...
                            <div class="mt-3" id="pnrBox" style="display: none;">
                                <form method="GET" action="{{ url('flight-booking/status/change/'.$data->id.'/3') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="pnr" value="{{ $data->pnr }}" class="form-control" placeholder="Enter PNR No...">
                                    </div>
                                    <div class="form-group">
                                        <label for="remarks">Enter Flight Number</label>
                                        <input type="text" name="flight_no" value="{{ $data->flight_no }}" class="form-control" placeholder="Enter Flight No...">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                       ...
                                       @if (count($formattedTravellers) > 0)
                                        ...
                                        <tr>
                                            <td class="text-muted">Flight Number : </td>
...
<script>
   ...
   $(document).ready(function() {
     ...
     $('#ticket').on('change', function() {
        ...
        $.ajax({
            url: "{{ route('flight.upload.ticket', $data->id) }}",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
