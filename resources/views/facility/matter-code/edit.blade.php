            ...
            <div class="col-md-12">
                ...
                <div class="card data-card">
                    <div class="card-header">
                        <h4 class="d-flex">Edit Matter Code
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-8 col-12">
                                <form action="{{ url('matter-code/'.$data->id) }}" method="POST" class="data-form">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="matter_code" value="{{ $data->matter_code }}" class="form-control" />
