...
@section('title', 'Cab Booking History')
...
<div class="container py-5">
    ...
    @forelse($bookings as $booking)
        <div class="card shadow-sm border-0 mb-4 booking-card rounded-4 overflow-hidden">
            <div class="card-body p-4">
                ...
                <div class="row gy-3">
                    <div class="col-md-6">
                        <p class="mb-2"><strong>Date of Travel:</strong> {{ \Carbon\Carbon::parse($booking->pickup_date)->format('d-m-Y') }}</p>
                        <p class="mb-2"><strong>Pick-Up Time</strong> {{ $booking->pickup_time }}</p>
                    ...
                    <div class="row gy-3 align-items-start">
                        <div class="col-md-6">
                            ...
                            <p class="mb-2">
                                ...
                                <span class="text-dark fw-semibold">{{ $booking->cab_no ?? '—' }}</span>
                            </p>
                        </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4 flex-wrap">
                    <a href="{{ route('front.travel.cab.edit', $booking->order_no) }}" 
    ...
    @empty
        <div class="text-center py-5 text-muted">
            ...
            <p class="mt-2">No cab bookings found.</p>
        </div>
    @endforelse
</div>
...
<div class="modal fade" id="cancelModal" tabindex="-1" aria-labelledby="cancelModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 rounded-4">
      <form method="POST" action="{{ route('front.travel.cab.cancel') }}">
        @csrf
