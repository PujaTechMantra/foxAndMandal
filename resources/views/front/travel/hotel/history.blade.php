...
@section('title', 'Accommodation History')
...
<div class="container py-5">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap">
        <div class="d-flex align-items-center mb-3 mb-md-0">
            <a href="{{ route('front.travel.hotel.index') }}" 
               class="back-btn d-flex align-items-center justify-content-center me-3 text-decoration-none">
                <i class="bi bi-arrow-left"></i>
            </a>
            <h3 class="mb-0 fw-semibold text-dark">Accommodation History</h3>
        </div>
    </div>
        ...
        <div class="card shadow-sm border-0 mb-4 booking-card rounded-4 overflow-hidden">
            <div class="card-body p-4">
                ...
                @if($booking->status == 3)
                    ...
                    <div class="row gy-3 align-items-start">
                        <div class="col-md-6">
                            ...
                            <p class="mb-2">
                                <strong>hotel Number :</strong> 
                                <span class="text-dark fw-semibold">{{ $booking->hotel_no ?? '—' }}</span>
                            </p>
                        </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4 flex-wrap">
                    <a href="{{ route('front.travel.hotel.edit', $booking->order_no) }}" 
    ...
    @empty
        <div class="text-center py-5 text-muted">
            ...
            <p class="mt-2">No hotel bookings found.</p>
        </div>
    @endforelse
</div>
...
<div class="modal fade" id="cancelModal" tabindex="-1" aria-labelledby="cancelModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 rounded-4">
      <form method="POST" action="{{ route('front.travel.hotel.cancel') }}">
        @csrf
