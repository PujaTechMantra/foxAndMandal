...
<body>
    ...
    <div class="container">
        ...
        <p>Dear {{ $name }},</p>
        <p>Your bus booking request has been confirmed.</p>
            ...
            <div class="">
                <div class=""  style="font-weight: bold;">Confirmation Details</div>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>PNR</td>
                                            <td rowspan="">{{ $busBooking->pnr }}</td>
                                        </tr>

                                        <tr>
                                            <td>Bus Number</td>
                                            <td rowspan="">{{ $busBooking->train_no }}</td>
                                        </tr>

                                        <tr>
                                            <td>Dept. date & time</td>
                                            <td rowspan="">{{ date('d-m-Y H:i',strtotime($busBooking->date_time)) }}</td>
                                        </tr>
