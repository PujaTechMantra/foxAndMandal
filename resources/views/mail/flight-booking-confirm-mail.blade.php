...
<body>
    ...
    <div class="container">
        ...
        <p>Dear {{ $name }},</p>
        <p>Your flight booking request has been confirmed.</p>
            ...
            <div class="">
                <div class=""  style="font-weight: bold;">Confirmation Details</div>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>PNR</td>
                                            <td rowspan="">{{ $flightBooking->pnr }}</td>
                                        </tr>

                                        <tr>
                                            <td>Flight Number</td>
                                            <td rowspan="">{{ $flightBooking->flight_no }}</td>
                                        </tr>

                                        <tr>
                                            <td>Dept. date & time</td>
                                            <td rowspan="">{{ date('d-m-Y H:i',strtotime($flightBooking->date_time)) }}</td>
                                        </tr>
