...
<body>
    ...
    <div class="container">
        ...
        <p>Dear {{ $name }},</p>
        <p>Your train booking request has been confirmed.</p>
            ...
            <div class="">
                <div class=""  style="font-weight: bold;">Confirmation Details</div>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>PNR</td>
                                            <td rowspan="">{{ $trainBooking->pnr }}</td>
                                        </tr>

                                        <tr>
                                            <td>Train Number</td>
                                            <td rowspan="">{{ $trainBooking->train_no }}</td>
                                        </tr>

                                        <tr>
                                            <td>Dept. date & time</td>
                                            <td rowspan="">{{ date('d-m-Y H:i',strtotime($trainBooking->date_time)) }}</td>
                                        </tr>
